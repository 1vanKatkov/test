...
def _translations(lang: str) -> dict:
    if lang == "en":
        return {
            ...
            "sign_in_required_text": f"You already used {settings.guest_free_readings_limit} free readings. Create an account or log in to continue.",
            "guest_free_cta_suffix": "0",
            ...
            "persona_required_error": "Choose a saved persona or enter name and birth date.",
            "personas": "Personas",
            ...
            "support_email_hint": "Contact email:",
            "optional": "optional",
    ...
    return {
        ...
        "sign_in_required_text": f"Вы использовали {settings.guest_free_readings_limit} бесплатных разбора. Создайте аккаунт или войдите, чтобы продолжить.",
        "guest_free_cta_suffix": "0",
        ...
        "persona_required_error": "Выберите сохранённую персону или введите имя и дату рождения.",
        "personas": "Персоны",
        ...
        "support_email_hint": "Контакт для связи:",
...
def _client_template_context(request: Request, lang: str, selected_card_topic: str = "") -> dict:
    ...
    return {
        ...
        "assets_version": "design-unify-v6",
